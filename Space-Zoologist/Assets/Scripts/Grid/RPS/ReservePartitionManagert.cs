...
//    TileSystem tileSystem; //GetTerrainTile API from Virgil
...
//            TerrainTile tile = tileSystem.GetTerrainTileAtLocation(cur);
...
//        while (p < 100)
//        {
//            if (tileSystem.GetTerrainTileAtLocation(WorldToCell(new Vector3(p, 0, 0))) != null)
//            {
//                break;
//            }
//            else
