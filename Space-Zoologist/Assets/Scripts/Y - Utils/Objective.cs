...
public class SurvivalObjective : Objective
{
 ...
 /*           if (population.Count >= this.TargetPopulationSize)
    ...
    public override string GetObjectiveText()
    {
        ...
        {
            displayText += $"Reach a population size of {this.TargetPopulationSize} {this.AnimalSpecies.ID.Data.Name.Get(ItemName.Type.Science)}s\n\n";
        ...
        displayText += $"{this.AnimalSpecies.ID.Data.Name.Get(ItemName.Type.Science)} {population} with a count of {this.TargetPopulationSize}";
