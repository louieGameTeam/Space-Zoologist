...
public class PlacementValidation : MonoBehaviour
{
    ...
    public void updateVisualPlacement(Vector3Int gridPosition, Item selectedItem)
    {
        ...
        else if (this.ReferenceData.AnimalSpecies.ContainsKey(selectedItem.ID))
        {
            AnimalSpecies species = this.ReferenceData.AnimalSpecies[selectedItem.ID];
    ...
    {
        return this.ReferenceData.AnimalSpecies[item.ID];
    }
}
